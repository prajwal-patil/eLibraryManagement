                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img src="img/generaluser.png" alt="user-login-icon" class="img-fluid" width="100"/>
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="TextBox7" runat="server" Placeholder="Address" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <asp:Label class="badge rounded-pill bg-info" ID="Label2" runat="server" Text="Your book info"></asp:Label>
                                </center>
                            </div>
                        </div>
                        <div class="row">
